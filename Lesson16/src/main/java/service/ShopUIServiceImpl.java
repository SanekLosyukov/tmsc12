...
import static form.ProductForm.fromGood;
import static form.ProductForm.toGood;
import static java.util.Collections.reverse;
import static java.util.Comparator.comparing;
import static util.DrawUI.*;
import static util.InputUtils.readIntFromConsole;
import static util.InputUtils.readStringFromConsole;
